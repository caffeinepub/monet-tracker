...
export class Backend implements backendInterface {
    ...
    async getTotalByCategory(arg0: Category): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateExpense(arg0: string, arg1: bigint, arg2: Category, arg3: string, arg4: string | null): Promise<Expense> {
        if (this.processError) {
            try {
                const result = await this.actor.updateExpense(arg0, arg1, arg2, arg3, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg4));
                return from_candid_Expense_n2(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
